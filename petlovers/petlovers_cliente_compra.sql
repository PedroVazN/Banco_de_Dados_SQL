...
CREATE TABLE `cliente_compra` (
  `id_cliente_compra` int NOT NULL AUTO_INCREMENT,
  `id_clientes` int NOT NULL,
  `id_produtos` int NOT NULL,
  PRIMARY KEY (`id_cliente_compra`),
  KEY `fk_produtos_idx` (`id_produtos`),
  KEY `fk_clientes_idx` (`id_clientes`),
  CONSTRAINT `fk_clientes` FOREIGN KEY (`id_clientes`) REFERENCES `clientes` (`id_clientes`),
  CONSTRAINT `fk_produtos` FOREIGN KEY (`id_produtos`) REFERENCES `produtos` (`id_produtos`)
...
-- Dump completed on 2024-03-19 16:42:16
